...
<body>
<jsp:useBean id="members" class="java.util.ArrayList" scope="session" />
			...
			<div class="wrap">
				...
				<div class="top-nav">
					<ul>
						...
						<li  style="margin-right: 30px"><a href="http://localhost:8081/ProjetStruts/toffres">Delete Ad</a></li>
						<li class="active" style="margin-right: 30px"> <a href="http://localhost:8081/ProjetStruts/Suppri_membre">Delete member</a></li>
					</ul>
				</div>
				<div class="clear"></div>
			</div>
	...
	<table>     
		<%
     			for (int i = 0; i < members.size(); i++) {
     				Membre an = (Membre)members.get(i);
     		%>
		<tr class="bdd">
			<div class="bd">
				<td class='categ'><%=an.getNom()%>&nbsp &nbsp<%=an.getPrenom()%></td>
			</div>
			<div class="bd">
				<td class='categ'><%=an.getEmail()%></td>
			</div>

			<div class="bd">
				<td class='categ'><%=an.getTelephone()%></td>
			</div>
			<div class="bd">
				<td ><a href="http://localhost:8081/ProjetStruts/supprimbr?id=<%=an.getEmail() %>"><input class='button' style="height:40px; width: 150px" type="button" value="Supprimer"></a></td>
			</div>
